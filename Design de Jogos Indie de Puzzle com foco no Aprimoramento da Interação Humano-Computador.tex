...
\titulo{Design de Jogos Indie de Puzzle com foco no Aprimoramento da Interação Humano-Computador}
% caso não haja, comente a linha abaixo
% \subtitulo{subtítulo (se houver)}

\autor{Aloísio Marques Lingo Filho}
\orientador{Prof. Me. Luiz Angelo Valota Francisco}
% caso não haja, comente a linha abaixo
